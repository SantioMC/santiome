	...
	<div class="card flex flex-col gap-8">
		<div class="flex items-center gap-3">
			...
			<div class="flex flex-col">
				...
				<p class="font-mono text-sm leading-4 text-secondary">Software Engineer</p>
			</div>
		</div>

		<section>
			<p>
				Hello there 👋, I'm Santio, a backend and infrastructure developer from Canada. I'm
				primarily a backend developer but in recent years I've been working with tools such as
				Kubernetes, Terraform, and other CI/CD tools to help manage and scale infrastructure for
				some of my work. Check out my <a href="https://github.com/SantioMC" target="_blank"
					>Github</a
				>, or reach out to me on
				<a href="https://discord.com/users/239752804468654090" target="_blank">Discord</a>
			</p>
		</section>
		...
		<section>
			...
			<p>
				...
				more prominent ones below, these are also places I've both contributed to or worked at.
				Check them out 😋.
			</p>
		...
		<section>
			...
			<p>
				Check out some of these awesome people who are so extremely talented in what they do. Click
				on their 88x31 badge to see their website.
			</p>
			...
			<div class="mt-4 flex flex-wrap gap-2">
				...
				<Badge name="Jos" src="/badge/jos.gif" href="https://jos.gg/" />
			</div>
		</section>
	</div>
